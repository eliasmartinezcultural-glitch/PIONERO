export const CONTENT={
  project:{version:"0.3.1",title:"PIONERO",subtitle:"Viaje por la historia de San Patricio del Chañar"},
  scenes:{
    ...
    "1975":{theme:"community",description:"Producción, educación y vida cotidiana comienzan a dejar nuevas huellas."},
    "present":{theme:"present",description:"El punto de llegada: el Chañar contemporáneo."}
  },
  points:{
    "before-1973":[{id:"territory",title:"El territorio",entityId:"place-chanar",kind:"reconstruction",text:"Reconstrucción didáctica: no representa literalmente una fotografía del pasado.",x:28,y:47}],
    ...
    "present":[{id:"today",title:"El presente",entityId:"place-chanar",kind:"interpretation",text:"La capa actual se ampliará con fotografías, mapas y registros contemporáneos.",x:66,y:53}]
  }
};